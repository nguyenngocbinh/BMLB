...
\cvname{Bình Nguyễn Ngọc} % Your name

\cvjobtitle{Bachelor} % Job title/career
\cvdate{January 2022} % Date of birth or date of CV??
\cvaddress{National Economic University, Viet
Nam} % Short address/location, use \newline if more than 1 line is required
\cvnumberphone{+84 98 688 2207} % Phone number
\cvsite{\href{http://\url{https://nguyenngocbinh.github.io/}}{\url{https://nguyenngocbinh.github.io/}}} % Personal website
\cvmail{\href{mailto:nguyenngocbinhneu@gmail.com}{\nolinkurl{nguyenngocbinhneu@gmail.com}}} % Email address
\cvtwitter{\href{https://twitter.com/nanabi88}{nanabi88}}
\cvgithub{\href{https://github.com/nguyenngocbinh}{nguyenngocbinh}}
\cvlinkedin{\href{https://www.linkedin.com/in/mariecurie}{mariecurie}}

\lfoot{\sf Curriculum Vitae: Bình Nguyễn Ngọc}
\rfoot{\sf\thepage}
...
\begin{twenty}
    \twentyitem{2006-10}{Bachelor in Mathematical Economics}{National Economic University}{Ha Noi, Viet Nam\par\empty}
\end{twenty}
